...
const FIRST_NAMES = [
  'Sarah', 'James', 'Maria', 'David', 'Aisha', 'Chen', 'Diego', 'Emma', 'Omar', 'Nina',
  'Liam', 'Sofia', 'Noah', 'Priya', 'Lucas', 'Grace', 'Mateo', 'Zara', 'Ethan', 'Leah',
  'Amir', 'Hannah', 'Ivan', 'Ruby', 'Kai', 'Elena', 'Marcus', 'Yuki', 'Rosa', 'Tomas',
];

const LAST_NAMES = [
  'Mitchell', 'Chen', 'Hernandez', 'Patel', 'Nguyen', 'Johnson', 'Kowalski', 'Rossi',
  'Okafor', 'Silva', 'Andersen', 'Kim', 'Murphy', 'Haddad', 'Novak', 'Reyes', 'Fischer',
  'Costa', 'Wallace', 'Ibrahim', 'Petrov', 'Sato', 'Lindqvist', 'Bauer', 'Dubois',
];

const COMPANY_HEADS = [
  'Summit', 'Harbor', 'Bright', 'Ironwood', 'Northwind', 'Cedar', 'Vertex', 'Meridian',
  'Copper', 'Lumen', 'Granite', 'Willow', 'Atlas', 'Sterling', 'Pioneer', 'Beacon',
];
const COMPANY_TAILS = [
  'Industries', 'Logistics', 'Group', 'Partners', 'Systems', 'Labs', 'Works', 'Collective',
  'Solutions', 'Trading', 'Supply', 'Holdings', 'Consulting', 'Studio', 'Co',
];

const WORDS = [
  'quarterly', 'onsite', 'priority', 'standard', 'follow-up', 'inspection', 'install',
  'repair', 'review', 'renewal', 'onboarding', 'maintenance', 'upgrade', 'assessment',
  'consultation', 'delivery', 'setup', 'audit', 'planning', 'kickoff', 'handover',
];

const CITIES = [
  'Springfield', 'Riverside', 'Fairview', 'Kingston', 'Ashford', 'Brookline', 'Clayton',
  'Easton', 'Fremont', 'Gardner', 'Hillcrest', 'Lakewood', 'Maplewood', 'Oakdale',
];
